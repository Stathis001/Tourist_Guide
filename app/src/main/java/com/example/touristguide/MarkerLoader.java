...
public class MarkerLoader implements GoogleMap.OnMarkerClickListener {
    ...
    public MarkerLoader(GoogleMap map) {
        ...
        allMarkers.add(map.addMarker(new MarkerOptions().position(new LatLng(41.092479913425834, 23.548556365564238)).title("Anastasios eskitzis- Reumatologos (Ιατρείο)").snippet("This is marker 1's snippet")));
        allMarkers.add(map.addMarker(new MarkerOptions().position(new LatLng(41.09034269429762, 23.55348399478657)).title("Maria Kokarida - Wrila Ιατρείο").snippet("This is marker 1's snippet")));
        allMarkers.add(map.addMarker(new MarkerOptions().position(new LatLng(41.08731152657037, 23.55017293627774)).title("Orthopaidiko iatreio enilikwn kai paidwn Ιατρείο").snippet("This is marker 1's snippet")));
        allMarkers.add(map.addMarker(new MarkerOptions().position(new LatLng(41.08731152657037, 23.55017293627774)).title("Orthopaidiko iatreio enilikwn kai paidwn Ιατρείο").snippet("This is marker 1's snippet")));
        allMarkers.add(map.addMarker(new MarkerOptions().position(new LatLng(41.07529662776701, 23.55353525970813)).title("dipae (Σχολείο)").snippet("This is marker 1's snippet").contentDescription("some description")));
        allMarkers.add(map.addMarker(new MarkerOptions().position(new LatLng(41.09835129725971, 23.551927608268336)).title("Lofos Koyla (Ιστορικό αξιοθέατο)").snippet("This is marker 1's snippet")));
        allMarkers.add(map.addMarker(new MarkerOptions().position(new LatLng(41.09156654135183, 23.559917963233605)).title("Achmet Pasa Tzami (Χώρος Λατρείας)").snippet("This is marker 1's snippet")));
        allMarkers.add(map.addMarker(new MarkerOptions().position(new LatLng(41.08828964518851, 23.553439602363994)).title("Ζιντζιρλί Τζαμί (Χώρος Λατρείας)").snippet("This is marker 1's snippet")));
        allMarkers.add(map.addMarker(new MarkerOptions().position(new LatLng(41.09146333054632, 23.55051494660206)).title("Liberty Square (Τουριστικό αξιοθέατο)").snippet("This is marker 1's snippet")));
        allMarkers.add(map.addMarker(new MarkerOptions().position(new LatLng(41.090984162331786, 23.54966866588395)).title("Archeological Museum of Serres (Bezesteni) (Ιστορικό αξιοθέατο)").snippet("This is marker 1's snippet")));
        allMarkers.add(map.addMarker(new MarkerOptions().position(new LatLng(41.10059767457084, 23.57097613512557)).title("Natural History Museum (Ιστορικό αξιοθέατο)").snippet("This is marker 1's snippet")));
